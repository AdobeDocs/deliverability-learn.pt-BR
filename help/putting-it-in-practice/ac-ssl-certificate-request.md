...
Depois de delegar um domínio ao Adobe para enviar emails (consulte [Domain name setup](/help/putting-it-in-practice/ac-domain-name-setup.md)), o Adobe criará e usará determinados subdomínios para funções específicas.
